...
Triangle_Mesh::Triangle_Mesh(std::vector<Geometry::Vertex> p):
	vertex{p}
{
...
Triangle_Mesh::Triangle_Mesh(std::vector<Geometry::Vertex> p, std::vector<int> i):
	vertex{p},
	index{i}
{}
...
void Triangle_Mesh::add(std::vector<Geometry::Vertex> p){
	Triangle_Mesh a(p);
	add(a);
}
...
Geometry::Vertex& Triangle_Mesh::Element::operator[](int i){
